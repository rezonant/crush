module Crush
	# Base class for all crush exceptions.
	class Exception < ::RuntimeError; end

	# Client was not authorized by remote server; check credentials.
	class NotAuthorized < Exception; end

	# crushd is not running on the remote box.
	class CrushdNotRunning < Exception; end

	# An unrecognized status code was returned by crushd.
