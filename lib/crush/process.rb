# An array of these objects is returned by Crush::Box#processes.
class Crush::Process
	attr_reader :box, :pid, :uid, :parent_pid, :command, :mem, :cpu, :user
	...
	def kproc_name
		if ::File.directory? '/proc'
			File.new("/proc/{#pid}/task/{#pid}/name")
		else
	...
	# Returns the Crush::Process parent of this process.
	def parent
	...
	def self.all
		Crush::Box.new('localhost').processes
	end
end  
