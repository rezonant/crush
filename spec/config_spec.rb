...
describe Crush::Config do
	before do
		@sandbox_dir = "/tmp/crush_config_spec.#{Process.pid}"
		system "rm -rf #{@sandbox_dir}"
		@config = Crush::Config.new(@sandbox_dir)
	end
	...
	it "can access the history file" do
		@config.history_file.class.should == Crush::File
	end
	...
	it "loads usernames and password for crushd" do
