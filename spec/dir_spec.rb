...
describe Crush::Dir do
	...
	it "is a child of Crush::Entry" do
		@dir.should be_kind_of(Crush::Entry)
	end
	...
	it "lists files" do
		@dir.create_file('a')
		@dir.files.should == [ Crush::File.new("#{@dirname}/a") ]
	end

	it "lists dirs" do
		system "mkdir -p #{@dir.full_path}/b"
		@dir.dirs.should == [ Crush::Dir.new("#{@dirname}/b") ]
	end
	...
	it "[] can return a file that has yet to be created" do
		@dir['not_yet'].class.should == Crush::File
	end
